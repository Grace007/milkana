        ...
        <section id="content">
            ...
            <div class="page page-dashboard">
                ...
                <div class="pageheader">
                    ...
                    <h2>User Center Update Profile <span></span></h2>
                            ...
                            <div class="tile-body">
                                ...
                                <form name="form1" role="form" id="form1" novalidate="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="${email}" type="email" name="email" id="email" class="form-control" data-parsley-trigger="change" required="" data-parsley-id="2219"><ul class="parsley-errors-list" id="parsley-id-2219"></ul>
                                    </div>
                                    ...
                                    <#--<div class="row">-->
                                        ...
                                        <#--<div class="form-group col-md-6">-->
                                            ...
                                            <#--<input type="password" name="password" id="password" class="form-control" data-parsley-trigger="change" data-parsley-range="[4, 20]" required="" data-parsley-id="1522"><ul class="parsley-errors-list" id="parsley-id-1522"></ul>-->
                                        <#--</div>-->

                                        <#--<div class="form-group col-md-6">-->
                                            <#--<label for="passwordConfirm">Password confirmation: </label>-->
                                            <#--<input type="password" name="passwordConfirm" id="passwordConfirm" class="form-control" data-parsley-trigger="change" data-parsley-range="[4, 20]" data-parsley-equalto="#password" required="" data-parsley-id="8737"><ul class="parsley-errors-list" id="parsley-id-8737"></ul>-->
                                        <#--</div>-->
...
<#include "static/footer.ftl" >
    ...
    <script>
        $(window).load(function(){
		    ...
		    $('#menu5-1').addClass('active');
            $('#btn_update').click(function (event) {
                var e_user = $("#username").val();
