...
//
//        PdfDocument pdfDocument_temp = document.getPdfDocument();
//        System.out.println("pdfDocument_temp = " + pdfDocument_temp.getNumberOfPages());
//        System.out.println("pdfDocument = " + pdfDocument.getNumberOfPages());
...
//            System.out.println("documentEvent.getDocument().getNumberOfPages() = " + documentEvent.getDocument().getNumberOfPages());
//            System.out.println("pdfDocument = " + pdfDocument.get);
            ...
            try {
                new PdfCanvas(documentEvent.getPage())
                        ...
                        .moveText(500, 806)
                        .showText("-"+Integer.toString(documentEvent.getDocument().getNumberOfPages())+"-")
                        .endText()
                        .stroke();
            } catch (IOException e) {
                e.printStackTrace();
